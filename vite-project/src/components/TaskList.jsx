...
export default function TaskList({ tasks, isLoading, loadingText, onHandleDisableEditMode, onSelectStatus, editTaskIs, updateTasks, currentCategory, setEditTaskIs }) {
